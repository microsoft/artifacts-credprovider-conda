...
class ArtifactsKeyringBackend():
    ...
    # I dont see a need to cache anything here
...
resultUrl = "https://" + jsonResult['channel_alias']['location']
cred = ArtifactsKeyringBackend()
token = cred.get_credential(
    resultUrl + "pkgs/main/win-64/repodata.json", # remove second part after we support shorter URL server side
    None)
